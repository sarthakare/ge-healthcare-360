import {
  ...
  import WarmerModel from "../assets/warmer/model/Lullaby Warmer.glb";
  import WarmerVideo from "../assets/warmer/videos/01-Modes_of_Ventilation.mp4";
  ...
  const Warmer = () => {
    ...
    const hotspots = [
      { id: 1, name: "Device Display", position: [0, -2, 0.75] },
      { id: 2, name: "Patient bed compartment", position: [-0.5, -0.25, 0] },
      { id: 3, name: "Battery Compartment", position: [0.5, 2, 0] },
    ];
