...
const LEDPhototherapy = () => {
  ...
  const hotspots = [
    ...
    { id: 2, name: "Optimal Wavelength", position: [0, 2.25, 0.5] },
    { id: 3, name: "Faster Breakdown", position: [-0.5, 2.45, 0.55] },
  ...
  const hotspotsConfig = {
    1: {
      ...
      title: "Introduction",
      overview:
        "LED Phototherapy provides gentle jaundice treatment using optimized light.",
      features: ["Jaundice care", "Optimized LEDs", "Gentle therapy"],
      rotation: defaultRotation,
    },
    2: {
      videoSrc: VideoOptimalWavelength,
      title: "Optimal Wavelength",
      overview: "458 nm within 450-465 nm ensures accurate therapy.",
      features: ["458 nm", "Therapeutic window", "Accuracy"],
      rotation: { azimuthal: -Math.PI / 4, polar: Math.PI / 2},
    },
    3: {
      videoSrc: VideoFasterBilirubin,
      title: "Faster Breakdown",
      overview: "10 LEDs enable 28% faster bilirubin reduction.",
      features: ["10 LEDs", "28% faster", "Efficient"],
      rotation: defaultRotation,
    },
    4: {
      videoSrc: VideoDualIrradiance,
      title: "Dual Irradiance",
      overview: "Two levels support patient-specific care.",
      features: ["22 uW", "45 uW", "Flexible"],
      rotation: { azimuthal: -Math.PI / 1.5, polar: Math.PI / 2},
    },
    5: {
      videoSrc: VideoUniformLight,
      title: "Uniform Light",
      overview: "Even distribution supports consistent therapy.",
      features: ["Uniform", "Consistent", "Better outcomes"],
      rotation: defaultRotation,
    },
    6: {
      videoSrc: VideoEasyManeuverability,
      title: "Maneuverability",
      overview: "Adjustable and mobile design simplifies positioning.",
      features: ["Adjustable", "Mobile", "Easy use"],
      rotation: defaultRotation,
    },
    7: {
      videoSrc: VideoWhisperQuiet,
      title: "Quiet",
      overview: "No moving parts ensure quiet operation.",
      features: ["Silent", "Calm", "Infant friendly"],
      rotation: defaultRotation,
    },
    8: {
      videoSrc: VideoEnergyEfficient,
      title: "Energy Efficient",
      overview: "20W operation saves energy.",
      features: ["20W", "80% savings", "Efficient"],
      rotation: { azimuthal: -Math.PI / 1.5, polar: Math.PI / 2},
    },
    9: {
      videoSrc: VideoLongLedLife,
      title: "LED Life",
      overview: "Up to 50,000 hours reduces maintenance.",
      features: ["50,000 hours", "6 years", "Low upkeep"],
      rotation: defaultRotation,
    },
    10: {
      videoSrc: VideoGlobalSafety,
      title: "Certifications",
      overview: "FDA and CE approved.",
      features: ["FDA", "CE", "Safe"],
      rotation: defaultRotation,
    },
  };
